import DimissForm from '@/components/Forms/DimissForm/DimissForm';
...
const ModalDimiss = ({ documentId, onClose }: Props) => {
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 flex items-center justify-center bg-[rgba(0,0,0,.8)] z-[999]">
      ...
      >
        <DimissForm documentId={documentId} onClose={onClose} />
      </div>
    </div>
  );
};

export default ModalDimiss;
